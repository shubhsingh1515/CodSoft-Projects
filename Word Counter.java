...
public class WordCounter {
    public static void main(String args[]) {
        ...
        clear.setBackground(clearButtonColor);
        Color submitButtonColor = new Color(0, 250, 0);
        submit.setBackground(submitButtonColor);
